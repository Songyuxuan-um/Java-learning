...
<body>
    <div class="row layout">
        ...
        <div class="col-8 bg-secondary">
            ...
            <div class="box">
                <div class="row gx-3 mb-1">
                    ...
                    <div class="col-md-6">
                        <div class="info">
                            <div id="mentee">Mentee</div>
                            <span><?php if(isset($row['user_username'])) {echo $row['user_username'];}?></span>

                        </div>
                    </div>
                    <div class="col-4">
                        <div class="button">
                            <a href="manageAcc.php" class="btn btn-primary">Edit Profile</a>
                            ...
                            <div id="id01" class="modal-custom">
                                ...
                                <form class="modal-content" action="/action_page.php">
                                    <div class="del">
                                        ...
                                        <div class="clearfix">
                                            <a href="updatedAcc.php" class="cancelbtn">Cancel</a>
                ...
                <div class="minibox">
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="small mb-1"><strong>First name</strong></label>
                            <p>
                                <span><?php if(isset($row['user_fname'])) {echo $row['user_fname'];}?></span>
                            </p>
                        </div>
                        <!-- Form Group (Last name)-->
                        <div class="col-md-6">
                            <label class="small mb-1"><strong>Last name</strong></label>
                            <p>
                                <span><?php if(isset($row['user_lname'])) {echo $row['user_lname'];}?></span>
                            </p>
                        </div>
                    </div>
                    <!-- Form Row-->
                    <div class="row gx-3 mb-3">
                        <!-- Form Group (Age)-->
                        <div class="col-md-6">
                            <label class="small mb-1"><strong>Age</strong></label>
                            <p>
                                <span><?php if(isset($row['user_age'])) {echo $row['user_age'];}?></span>
                            </p>
                        </div>
                        <!-- Form Group (Gender)-->
                        <div class="col-md-6">
                            <label class="small mb-1"><strong>Gender</strong></label>
                            <p>
                                <span><?php if(isset($row['user_gender'])) {echo $row['user_gender'];}?></span>
                            </p>
                        </div>
                    </div>
                    <!-- Form Row  -->
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="small mb-1"><strong>Phone Number</strong></label>
                            <p>
                                <span><?php if(isset($row['user_phone_num'])) {echo $row['user_phone_num'];}?></span>
                            </p>
                        </div>
                        <!-- Form Group (Country)-->
                        <div class="col-md-6">
                            <label class="small mb-1"><strong>Country</strong></label>
                            <p>
                                <span><?php if(isset($row['user_country'])) {echo $row['user_country'];}?></span>
                            </p>
                        </div>
                    </div>
        ...
        <div class="col-3">
            ...
            <div class="row row-cols-1 d-grid gap-2 scroll_timeline_mentee scroll">
                <div class="col">
                    <div class="rem">
